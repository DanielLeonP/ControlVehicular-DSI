...
<?php
        if($TipoUsuario == "A"){
            $Form = $_GET['Form'];
            if($Form == "Conductores"){
                include("FConductores.html");
            }
            if($Form == "Licencias"){
                include("FLicencias.html");
            }
            if($Form == "Multas"){
                include("FMultas.html");
            }
            if($Form == "Propietarios"){
                include("FPropietarios.html");
            }
            if($Form == "Tarjetas"){
                include("FTarjetas.html");
            }
            if($Form == "Tenencias"){
                include("FTenencias.html");
            }
            if($Form == "Vehiculos"){
                include("FVehiculos.html");
            }
            if($Form == "Verificaciones"){
                include("FVerificaciones.html");
            }
        }    
    }else{
